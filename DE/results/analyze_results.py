...
for csv_file in csv_files:
    ...
    # Store aggregated results for this file
...
# Ranking and comparison - Rank-based approach
print("\n" + "="*80)
...
# For each file, calculate average rank across all problems
file_ranks = {}
problems = []
...
for problem in sorted(problem_results.keys(), key=lambda x: int(x[1:])):
    ...
    # Collect ranks for overall calculation
...
for file, ranks in file_ranks.items():
    ...
    # Combined rank: average of both (lower is better)
